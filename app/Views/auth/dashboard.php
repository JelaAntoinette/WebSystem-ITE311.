...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) { .container { padding: 20px 15px; } .welcome-card { padding: 30px 20px; } .welcome-card h2 { font-size: 28px; } .user-info-card { padding: 25px 20px; } .logout-btn { bottom: 20px; left: 20px; padding: 10px 16px; font-size: 13px; } .info-item { flex-direction: column; align-items: flex-start; gap: 5px; } }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <?php elseif ($user['role'] === 'student' && isset($courses)): ?>
                <div class="role-card">
                    <h5>My Courses</h5>
                    <ul>
